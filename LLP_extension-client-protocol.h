...
struct llp_touch_listener {
	 ...
	 * send_touch_event
	 */
	void (*send_touch_event)(void *data,
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) llp_touch,
			 LLP_TOUCH_GET_TOUCH_EVENT, NULL, wl_proxy_get_version((struct wl_proxy *) llp_touch), 0, x, y, w, h, touch_event);
}
